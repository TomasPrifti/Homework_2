...
function update(event) {
    ...
    if (form != null)
        fetch("suppliers/update", { headers: { 'x-csrf-token': token }, method: "post", body: form }).then(onResponse, onError).then(onAccess);
}
...
function login() {
    ...
    if (form != null)
        fetch("suppliers/login", { headers: { 'x-csrf-token': token }, method: "post", body: form }).then(onResponse, onError).then(onAccess);
}
...
function register() {
    ...
    if (form != null)
        fetch("suppliers/register", { headers: { 'x-csrf-token': token }, method: "post", body: form }).then(onResponse, onError).then(onAccess);
}
